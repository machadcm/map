...
*/
  ...
  */
  ...
  createMask() {
    return this._screen.create(this._map[0].length, this._map.length);
  }
  ...
  display(pos) {
    ...
    this._run.screenzero = this._screen.position(
      this._canvas,
      this._iconsize,
      pos,
      this._run.zoom
  ...
  handleEvent(e) {
    switch (e.type) {
      ...
      case "mouseup":
        ...
        var pos = this._screen.mouse(
          this._iconsize,
          this._run.screenzero,
          { x: e.clientX, y: e.clientY },
          this._run.zoom
        );

        if (
          pos.x !== this._run.screencenter.x ||
          pos.y !== this._run.screencenter.y
        ) {
